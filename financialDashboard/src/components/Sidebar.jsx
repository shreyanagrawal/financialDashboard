...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  return (
    <>
      ...
      <div className={`sidebar fixed top-0 left-0 h-screen pt-28 w-56 sm:w-64 bg-white shadow-lg p-6 z-[60]
        transform transition-transform duration-300 ${sidebarOpen ? "translate-x-0" : "-translate-x-full"} lg:top-24 lg:h-[calc(100vh-6rem)] lg:pt-6 lg:translate-x-0`}>
