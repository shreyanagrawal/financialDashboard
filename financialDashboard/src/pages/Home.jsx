    ...
    <div className="min-h-screen bg-gray-100">
      <div className="flex-1 p-8">
        <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-3xl p-8 text-white shadow-lg mb-8">
          <h1 className="text-4xl font-bold mb-3">Personal Finance Dashboard</h1>
          <p className="text-blue-100 text-lg">Track your spending, manage budgets, and monitor your financial health.</p>
        </div>
