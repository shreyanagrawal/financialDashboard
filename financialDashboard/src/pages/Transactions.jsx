            ...
            <div className="p-5">
                ...
                <div className="rounded-2xl">
                    <div className="flex flex-col md:flex-row gap-3 md:gap-0 md:justify-between md:items-center mb-6">
                        ...
                        <button onClick={() => setIsModalOpen(true)} className="text-end bg-gradient-to-r from-blue-600 to-indigo-700 px-5 py-2 rounded-xl font-semibold text-white cursor-pointer ml-auto">Add Transaction</button>
                    </div>
